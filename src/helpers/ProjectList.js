...
export const ProjectList = [
	{
		name: 'Pong Game',
		image: Pong,
		url: 'https://github.com/berkaytorun/Pong_game',
		skills: ['webGl', 'Js'],
	},
	{
		name: 'Discord Chat Bot',
		image: Discord,
		url: 'https://github.com/berkaytorun/DiscordBot',
		skills: ['Js'],
	},
	{
	...
	{
		name: 'Arduino Solar Panel Light Tracker',
		image: Arduino,
		url: 'https://github.com/berkaytorun/SunTrackerWithArduino',
		skills: ['C'],
	},
	{
